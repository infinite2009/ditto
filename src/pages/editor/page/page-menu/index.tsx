...
import { MouseEventHandler, PropsWithChildren, useContext, useMemo, useRef } from 'react';
...
function PageMenu({ children, className }: MenuProps) {
  ...
  const handleSelectingMenu: any = ({ key, keyPath }) => {
